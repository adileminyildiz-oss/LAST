...
const r = await page.evaluate(async () => {
  ...
  out.navTrim = Array.isArray(PAGES) && PAGES.map(p => p.id).join(',') === 'cockpit,demandes,espace,formulaire,editions,agenda,clients,pilotage,prestataires,services,params';
